...
ne vrijedi sasvim. U ovom ćemo odjeljku, uglavnom ćemo
...
Za to je prvo potrebno uvesti neke pojmove koji opisuju topološka
svojstva grupe.
...
(Podsjetimo se da je u algebri definirano zbrajanje elemenata $X+Y$ i njihov
 komutator $[X, Y]$, ali ne i množenje $X Y$.)
...
je sadrži kao podrgrupu, kao SO(3), SU(2) etc., neće biti injektivno pokrivena
