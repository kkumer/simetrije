...
\begin{primjer}[Lieva algebra grupe \SU{2} tj. \suAlg{2}] \label{pr:su2so3Alg}
...
$\SO{1,1}$.
\item Grupni prostor kvocijentne grupe $G/H$ Lieve grupe $G$ po diskretnoj normalnoj podgrupi $H$
    ...
    \begin{multline}
        f(r, \theta, \phi) = \\ \left( 
            ...
            \right) \,.
    \end{multline}
    Inače, ovaj prostor matematičari zovu \emph{realni projektivni prostor}
    $\mathbb{RP}^{3}$.
\end{enumerate}
