...
vjernu reprezentaciju grupe \SU{2} (vidi zadatak  \ref{zad:svojstvapaulijevi})
\begin{equation}
...
(za diskusiju u kontekstu kvantne fizike vidi \cite{Weinberg}),
...
\begin{itemize}
    ...
    \item \SO{3} je dvostruko povezana i dopušta dvije faze: $\pm 1$. Fermionski
          ...
          da preslikavanje s elementa grupe rotacija ide u skup od dva operatora ($U$ i $-U$)
          iz \SU{2}.
\end{itemize}
...
situacije gdje rotacije kod kojih rotacije za 360 stupnjeva nisu identične
rotaciji za nula stupnjeva, a one za 720 stupnjeva jesu (poznati trikovi
s pojasom ili konobarevim pladnjem). Također, najjednostavniji odgovor na
pitanje kako komponirati dvije prostorne rotacije dobije se upravo korištenjem
