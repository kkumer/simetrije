...
slijedećem odjeljku. Klasične reference za napredniji studij ovih
...
\subsubsection{Dimenzija SU(N) reprezentacije reprezentirane Youngovim dijagramom}
...
\subsubsection{Clebsch-Gordanov razvoj za SU(N) reprezentacije}
