...
bavit ćemo se Lorentzovim, Poincar\'{e}ovim i konformalnim
...
ponašanje čestica obzirom na tzv. slabe i jake sile.
Povijesno su istraživači nailazili na mnoge teškoće u formuliranju
ispravnih teorija tih sila, a i dan danas npr. ne znamo riješiti jednadžbe
gibanja koje su posljedica jake sile; i tu su se svojstva simetrija
opaženih u prirodi pokazala kao izuzetno korisna.
Najveći trijumf fizike visokih energija druge polovice XX. i početka
XXI. stoljeća je finalizacija tzv. standardnog modela fizike elementarnih
čestica čije je struktura praktički potpuno određena njegovom
tzv. baždarnom simetrijom, čija je grupa $\SU{3} \otimes \SU{2} \otimes \U{1}$. 
...
što je od velike koristi pri izgradnji trenutnih i budućih teorija
...
treće komponente izospina
\begin{align}
   \ket{p} & = \ket{I=\fhalf, I_3=\fhalf} \,, \\
   \ket{n} & = \ket{I=\fhalf,I_3=-\fhalf} \,,
\end{align}
je stvar konvencije.
...
S druge strane u prirodi \emph{ne} postoje stanja koja su superpozicija
protona i neutrona\footnote{To je posljedica tzv. superselekcijskih  pravila.}.
No i bez obzira na nepostojanje takvih stanja hipoteza izospina
iziskuje da teorija jakih sila bude simetrična na cijelu izospinsku grupu,
...
ni treće stanje $\ket{I=1, I_3=0}$ pa zaključujemo da je primjećeno deuteronsko
stanje $\ket{I=0, I_3 = 0}$.
...
i $S$ izoskalar ($I=0$). Cilj nam je pokazati da izospinska simetrija
...
tzv. \emph{Cartanovu podalgebru} date Liejeve algebre. 
