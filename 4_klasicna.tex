...
Npr. za slobodnu česticu $H=p^2/2m$ i
\begin{equation}
...
enormna. Konceptualno, unitarni operator $\mathcal{D}(\hat{\vec{n}}, \phi)$
...
\end{equation}
gdje smo upotrijebili Levi-Civita ili totalno antisimetrični pseudotenzor
...
vodi na važna svojstva valnih funkcija kristala.
\emph{Kristal} je ovdje definiran kao (beskonačni) 
