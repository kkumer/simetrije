...
koordinatnog sustava ne mijenja same vektore i ono što je onda
...
\vspace*{2ex}
\centerline{\input{figures/skalarvektor.tex}}
...
\begin{center}
    ...
    $R(\hat{\vec{n}}, \theta)$.
\end{center}
Ovo se poopćuje na veličine sa složenijim transformacijskim svojstvima,
\emph{tenzore}. 
...
\centerline{\input{figures/qmtranslacija}}
...
\centerline{\input{figures/infrotacija.tex}}
...
\centerline{\input{figures/spin.tex}}
