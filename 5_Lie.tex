...
\centerline{\input{figures/grupni_prostor.tex}}
...
\centerline{\input{figures/mnogostrukost.tex}}
...
\centerline{\input{figures/liejeva_mnogostrukost.tex}}
...
\centerline{\input{figures/so3mnogostrukost.tex}}
...
Druga zanimljivost vezana je uz kvocijentni skup \SU{2}/\U{1}. Grupna mnogostrukost
...
svi elementi grupe \SO{3} mogu dobiti eksponencijacijom generatora.
...
Za važnu kategoriju Liejevih grupa vrijedi da se svi elementi iz 
...
Međutim, primjer grupa \SO{3} i \SU{2} koje su obje povezane i kompaktne i koje
...
\end{definicija}
\begin{figure}[htpb]
\centerline{\input{figures/homotopija.tex}}
%\centerline{\includegraphics[scale=1.0]{pics/homotopija.eps}}
\caption{Primjeri krivulja iz triju neekvivalentnih klasa u \SO{2}. Radi preglednosti
...
U odjeljku \ref{sec:so3su2} smo vidjeli da je grupna mnogostrukost od \SO{3}
...
\centerline{\input{figures/dvostruka_povezanost_so3.tex}}
...
\centerline{\input{figures/so3pokrivanje.tex}}
...
\centerline{\input{figures/ucg.tex}}
