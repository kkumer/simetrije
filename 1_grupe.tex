...
zovemo \emph{prava} podgrupa i pišemo $H<G$.
...
Potpuno analogno se definiraju \emph{desna susjedna klasa} i \emph{desni kvocijentni skup}.
...
Na kvocijentnom skupu po normalnoj podgrupi moguće je definirati
binarnu operaciju "množenja" susjednih klasa putem\footnote{%
Kako ista susjedna klasa može biti definirana različitim
elementima $g_1 H = k_1 H$, ovdje je netrivijalno pokazati da 
ovako definirani umnožak ne ovisi o izboru elementa tj. da
je u svakom slučaju $(g_1 g_2)H  = (k_1 g_2)H$. Za dokaz
toga vidi literaturu.}
\begin{displaymath}
       (g_1H)(g_2H)=(g_1 g_2)H \;.
\end{displaymath}
Uvjerite se da obzirom na ovako definirano množenje
susjednih klasa, kvocijentni skup čini grupu.
...
{\rm C}_2\backslash{\rm D}_{3} &= \{\{e,b\}, \{c, bc\}, \{c^2, bc^2\}\}
    \neq {\rm D}_{3}/{\rm C}_2
\end{align*}
i $\mathrm{D}_{3}$/$\mathrm{C}_2$ nije grupa.
